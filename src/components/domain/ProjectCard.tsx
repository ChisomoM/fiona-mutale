...
import { Card, Chip, IconLink } from '../ui';
...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    ...
    >
      {/* Project Image */}
      <div className="aspect-video bg-gradient-to-br from-primary-500/20 to-primary-600/10 flex items-center justify-center relative overflow-hidden">
        {image ? (
          <img 
            src={image} 
            alt={title}
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          {tags.slice(0, 3).map((tech) => (
            <Chip key={tech} variant="secondary" className="text-xs">
              {tech}
            </Chip>
          ))}
          {tags.length > 3 && (
